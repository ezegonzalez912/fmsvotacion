...
export const Personajes = ({setPersonaje, personajes, competidor, ocultarTotal}) => {
    ...
    useEffect(() => {
        setPersonaje(funcionInput(input1) + funcionInput(input2) + funcionInput(input3) + funcionInput(input4) 
        ...
        checkBox1, checkBox2, checkBox3, checkBox4, checkBox5, checkBox6, setPersonaje])
        ...
        <Contenedor>
            ...
            <div className='inputs-contenedor'>
                <div className='contenedor-sangre'>
                    <input tabIndex='1' inputmode="tel" className='input' type='text' value={input1} onChange={ (e) => sumaRespuesta(e, setInput1, setCheckBox1)} />
                    <input tabIndex='-100' className='checkbox' type='checkbox' checked={checkBox1} onChange={() => setCheckBox1(!checkBox1)}/>
                </div>
                <div className='contenedor-sangre'>
                    <input tabIndex='2' inputmode="tel" className='input' type='text' value={input2} onChange={ (e) => sumaRespuesta(e, setInput2, setCheckBox2)} />
                    <input tabIndex='-100' className='checkbox' type='checkbox' checked={checkBox2}  onChange={() => setCheckBox2(!checkBox2)}/>
                </div>
                <div className='contenedor-sangre'>
                    <input tabIndex='3' inputmode="tel" className='input' type='text' value={input3} onChange={ (e) => sumaRespuesta(e, setInput3, setCheckBox3)} />
                    <input tabIndex='-100' className='checkbox' type='checkbox' checked={checkBox3}  onChange={() => setCheckBox3(!checkBox3)}/>
                </div>
                <div className='contenedor-sangre'>
                    <input tabIndex='4' inputmode="tel" className='input' type='text' value={input4} onChange={ (e) => sumaRespuesta(e, setInput4, setCheckBox4)} />
                    <input tabIndex='-100' className='checkbox' type='checkbox' checked={checkBox4}  onChange={() => setCheckBox4(!checkBox4)}/>
                </div>
                <div className='contenedor-sangre'>
                    <input tabIndex='5' inputmode="tel" className='input' type='text' value={input5} onChange={ (e) => sumaRespuesta(e, setInput5, setCheckBox5)} />
                    <input tabIndex='-100' className='checkbox' type='checkbox' checked={checkBox5}  onChange={() => setCheckBox5(!checkBox5)}/>
                </div>
                <div className='contenedor-sangre'>
                    <input tabIndex='6' inputmode="tel" className='input' type='text' value={input6} onChange={ (e) => sumaRespuesta(e, setInput6, setCheckBox6)} />
                ...
                {ocultarTotal ? <input tabIndex='-1' className='input input-resultado' readOnly value={personajes}/> : <input tabIndex='-1' className='input input-resultado' readOnly value='-'/>}
            </div>
    </Contenedor>
    )
}
