...
export const PrimeraTematica = ({competidor1, setTematicas1, tematicas1, competidor2, setTematicas2, tematicas2, ocultarTotal}) => {
    return (
        <div className='mode-contenedor'>
            <h2 className='mode-title'>PRIMERA TEMÁTICA</h2>
